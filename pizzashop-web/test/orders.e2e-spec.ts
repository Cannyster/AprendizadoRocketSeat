...
test('Paginate orders, next page', async ({page}) => {
    ...
    await expect(page.getByRole('cell', { name: 'Customer 12', exact: true })).toBeVisible()
...
test('Paginate orders, last page', async ({page}) => {
    ...
    await expect(page.getByRole('cell', { name: 'Customer 52', exact: true })).toBeVisible()
...
test('Paginate orders, previous page', async ({page}) => {
    ...
    await expect(page.getByRole('cell', { name: 'Customer 49', exact: true })).toBeVisible()  
});
...
test('Paginate orders, first page', async ({page}) => {
    ...
    await expect(page.getByRole('cell', { name: 'Customer 2', exact: true })).toBeVisible()
    await expect(page.getByRole('cell', { name: 'Customer 10', exact: true })).toBeVisible()  
});
...
test('Filter By Customer Name', async ({page}) => {
    ...
    await expect(page.getByRole('cell', { name: 'order-20', exact: true })).toBeVisible()
    await expect(page.getByRole('cell', { name: 'Customer 20', exact: true })).toBeVisible()
});
